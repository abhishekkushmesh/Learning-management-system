...
const Dashboard = () => {
  ...
  return dashboardData ? (
    <div className='flex flex-col items-start min-h-screen gap-8 p-4 pt-8 pb-0 justyfy-between md:p-8 md:pb-0'>
      <div className='space-y-5'>
        ...
        <div>
          <h2 className='text-lg font-medium pb--4'>Latest Enrolment</h2>
