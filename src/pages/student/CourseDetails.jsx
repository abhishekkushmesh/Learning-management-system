...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      <div className='relative flex items-start justify-between gap-10 px-8 pt-20 text-left md:flex-col-reserve md:px-36 md:pt-30 md:flex-row' >
        ...
        <div className='z-10 max-w-xl text-gray-500'>
          ...
          {/* review and rating */}
          <div className='flex items-center pt-3 pb-1 space-x-2 text-sm'> {/* Fixed "item-center" */}
            <p>{calculateRating(courseData)}</p> {/* Fixed incorrect text rendering */}
            <div className='flex'>
              {[...Array(5)].map((_, i) => (
                <img
                  key={i}
          ...
          <p className='text-sm'>Corse By <span className='text-blue-600 underline'>EduEleVate</span></p>
          ...
          <div className='py-20 text-sm md:text-default'>
            <h3 className='text-xl text-gray-800 fony-semibold'>Couse Description</h3>
        ...
        {/* right column */}
        <div className='z-10 overflow-hidden bg-white rounded-t max-w-course-card 
        shadow-custom-card md:rounded-none min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className='flex items-center gap-3 pt-2'>
            <p className='text-2xl font-semibold text-gray-800 md:text-4xl'>{currency}{(courseData.coursePrice - courseData.discount * 
          ...
          <div>
            <p className='text-lg font-medium text-gray-800 md:text-xl'>What's int the course?</p>
